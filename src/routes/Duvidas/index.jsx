    ...
    return(
        <main>
            <div class='container4'>
                ...
                <br />
                <h3>A cobertura de roubo garante furto simples?</h3>
                ...
                <br />
                <h3>O seguro de bike cobre qualquer tipo de acessório?</h3>
                ...
                <br /><br />Já acessórios de uso pessoal, não acoplados à bicicleta, como capacetes, luvas, squeezes, mochilas, roupas e ferramentas não são contemplados.</p>
                <br />
                <h3>Quem não tem nota fiscal pode contratar o seguro?</h3>
